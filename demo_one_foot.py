...
if __name__ == '__main__':
    ...
    Wb, Ab, PERIOD, _, time_datetime, time_elapsed_samples = imu.getdata_apdm(H5_FILE)

    # Define the section (in seconds) that will need to be processed and segment the IMU data accordingly
    SECTION = [(2200, 3500)]

    Wb, Ab, _, _, time_datetime, time_elapsed_samples = imu.getdata(
        Wb, Ab, PERIOD, SECTION, time_datetime=time_datetime, time_elapsed_samples=time_elapsed_samples)
